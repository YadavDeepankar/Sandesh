...
public class UserChooseState extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_user_choose_state);
    ...
    public void selectstate(View v) {
        ...
        if (spin1.getCount()==0){
            ...
            Intent i = new Intent(this, RetrieveMapActivity.class);
